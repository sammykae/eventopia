	...
	return (
		<>
			<Head
				...
				description={"Create an Eventopia listing here."}
			/>
			<>
			...
			<MainContentWrapper>
				...
				<div className={classes.titleLogoWrapper}>
					<img src={logo} alt="Eventopia logo" className={classes.logo} />
					<Typography
						variant="h4"
						component="h3"
						color="primary"
					...
					>
						NOTE: To create a listing you need input your username !
					</Typography>
				</div>
					...
					<SectionCard>
						...
						<div className={classes.space}>
							...
							<Typography variant="p" component="p" color="textSecondary">
								It is highly recommended to include the following information to
								make your listing stand out and be more searchable.
							</Typography>
							<FormGroup>
								<div>
									<TextField
						...
						<div className={classes.images}>
							...
							<div>
								...
								<Typography color="textSecondary">
									This will be featured prominently throughout the site, so make
									you it's a picture you really like!
								</Typography>
